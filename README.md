...
## Important workflow
1. New candidate registers and verifies OTP.
2. Account is created as pending/inactive.
3. Admin approves/activates the account and can assign the official email/password.
4. Student/teacher logs in using the active credentials.
5. Admin manages users. Teacher manages exams/questions/results. Student takes exams and sees published marks.
